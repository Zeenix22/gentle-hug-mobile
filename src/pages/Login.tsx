...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    // Auth logic will be wired in Phase 5
    setTimeout(() => {
      setIsLoading(false);
      toast({ title: "Coming soon", description: "Authentication will be enabled in Phase 5." });
    }, 1000);
  };
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => toast({ title: "Coming soon", description: "Password reset will be available in Phase 5." })}
                  className="text-xs text-primary hover:underline font-medium min-h-0 min-w-0"
                >
                  Forgot password?
                </button>
              </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              onClick={() => toast({ title: "Coming soon", description: "Google sign-in will be available in Phase 5." })}
            >
            ...
            <Button
              variant="outline"
              className="gap-2 text-sm font-medium"
              onClick={() => toast({ title: "Coming soon", description: "GitHub sign-in will be available in Phase 5." })}
            >
